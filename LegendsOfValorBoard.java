    ...
    public static class Builder {
        ...
        public LegendsOfValorBoard build() {
            ...
            for (int r = 1; r < SIZE - 1; r++) {
                for (int c = 0; c < SIZE; c++) {
                    if (c == 2 || c == 5) continue; // wall columns
        ...
        private TerrainType randomLaneTerrain(Random rand) {
            ...
            roll -= obstacleRate;
            if (roll < bushRate)   return TerrainType.BUSH;
            roll -= bushRate;
            if (roll < caveRate)   return TerrainType.CAVE;
            roll -= caveRate;
            if (roll < koulouRate) return TerrainType.KOULOU;
