...
public class Inventory {
    ...
    public List<Weapon> getWeapons() {
        ...
        for (Item i : items) if (i instanceof Weapon) res.add((Weapon) i);
        return res;
    }
    ...
    public List<Armor> getArmors() {
        ...
        for (Item i : items) if (i instanceof Armor) res.add((Armor) i);
        return res;
    }
    /**
    ...
    public List<Potion> getPotions() {
        ...
        for (Item i : items) if (i instanceof Potion) res.add((Potion) i);
        return res;
    }
    /**
    ...
    public List<Spell> getSpells() {
        ...
        for (Item i : items) if (i instanceof Spell) res.add((Spell) i);
        return res;
    }
}
