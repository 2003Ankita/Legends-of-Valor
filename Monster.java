/**
 * Abstract base class representing all monster types (Dragons, Spirits, Exoskeletons, etc.).
...
public abstract class Monster extends Character {
     ...
     * @param dodgeChance  dodge percentage from PDF (0–100), internally converted to probability
     */
