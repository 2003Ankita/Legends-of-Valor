...
public class GameController {
    ...
    private void mainLoop() {
        ...
        while (running) {
            ...
            switch (cmd) {
                ...
                case 'I': view.showInfo(party, null); break;
                case 'M': enterMarket(); break;
                case 'H': showHelpMenu(); break;
    ...
    private void startBattle() {
        ...
        if (enemies.isEmpty()) enemies.addAll(monsterPool);
        ...
        for (int i = 0; i < count; i++) {
            ...
            Monster m;
            if (enemies.get(idx).isBoss()) m = enemies.get(idx);
            else m = enemies.get(idx).copy();
            m.setLevel(lvl);
            chosen.add(m);
        }
    ...
    private Monster generateMiniBoss(int level) {
        ...
        base.hp = base.getLevel() * 200;
        base.damage *= 1.5;
        base.defense *= 1.3;
        base.dodgeChance *= 1.2;
        base.setBoss(true);
